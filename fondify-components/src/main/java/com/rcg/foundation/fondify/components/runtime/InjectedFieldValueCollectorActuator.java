 ...
 *
 */
public class InjectedFieldValueCollectorActuator implements FieldValueActuator {
	private ComponentsManager componentsManager = null;

	/**
	 * 
	 */
	public InjectedFieldValueCollectorActuator() {
		super();
	...
	public Object valueOfField(Field field) {
		try {
			...
			LoggerHelper.logError("InjectedFieldValueCollectorActuator::valueOfParameter", 
	...
	public boolean isAppliableTo(Field field) {
		return BeansHelper.getFieldAnnotation(field, Inject.class) != null;
	}
